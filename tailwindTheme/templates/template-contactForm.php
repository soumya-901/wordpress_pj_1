...
<p>Thanks for your interest. Enter your name and details so we can connect you with one of our team.</p>
                    <div class="">
    <form method="post" class="mt-8 space-y-6" action="">
        <div>
            <label for="name" class="block text-black-700">Your name</label>
            <input id="name" name="name" type="text" placeholder="Your name" class="mt-1 block w-full border-b-2 outline-none">
        </div>
        <div>
            <label for="email" class="block text-black-700">Your work email</label>
            <input id="email" name="email" type="email" placeholder="Your work email" class="mt-1 block w-full border-b-2 outline-none">
        </div>
        <div>
            <label for="phone" class="block text-black-700">Phone</label>
            <input id="phone" name="phone" type="tel" placeholder="Phone" class="mt-1 block w-full border-b-2 outline-none">
        </div>
        <div>
        ...
        <div>
        <button type="submit" name="submit" class="ml-[.5rem] w-[8rem] text-center sm:px-[.2rem] sm:text-[.6rem] lg:text-[.7rem] lg:px-[.5rem] font-bold text-white bg-black rounded-lg py-3 hover:bg-slate-500">Get Startes <span class="" >&rarr;</span> </button>
        </div>
    </form>
    <?php if ($submitted): ?>
