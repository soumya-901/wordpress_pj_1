                ...
                <div class="mt-[4rem] lg:mt-2 ">
                    ...
                    <svg width="60" height="60" viewBox="0 0 49 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="#F66135" />
                        <path
                            d="M12.3652 0C23.7089 3.47805 30.1376 15.6571 26.7215 27.2069C23.3084 38.7567 11.3438 45.3021 0 41.824L12.3652 0Z"
                            fill="#F66135" />
                    </svg>
        ...
        <div class=" bg-gray-200 px-[2.5rem] py-[4rem] xl:w-[40%]">
                ...
                <form action="" class="mt-[2rem] ">
                    ...
                    <button class="my-2 flex border-2 border-black rounded-[7px] px-[1.5rem] py-[.4rem] sm:ml-4 md:text-[1.2rem] hover:bg-black hover:text-white ">Subscribe
                        ...
                        <div class="flex">
                    <input type="checkbox" class="w-6 mr-1">
                    <p class="text-[.8rem] sm:text-[1rem]">By subscribing I accept the <span class="border-b border-black ">Privacy Policy.</span></p>
                </div>
                </form>
                ...
                <p class="flex "><span><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-phone" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  ...
                  <span class="text-[1.2rem]">+1 (408) 478-2739</span>
                    </p>
                <h2 class="text-[1.3rem] font-bold mt-[2rem] md:text-[2rem]">Follow us
                    <span class="text-orange-600">.</span></h2>
                <ul class="flex mt-[2rem] gap-4">
                    <li><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-linkedin"
                            width="25" height="25" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none"
